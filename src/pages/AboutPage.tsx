      ...
      <div className="about__container">
        <div className="about__description">
          ...
          <p className="about__text">
            ...
            across places, cultures, and time. We are also a place of active
            learning for all—dedicated to investigation, innovation, education,
            and dialogue—continually aspiring to greater public service and
            civic engagement.
          </p>
