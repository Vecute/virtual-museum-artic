  ...
  return (
    <TemplatePage title="About Project">
      <div className="project__container">
        <p>
          The site is a virtual museum based on the collection of{" "}
          <a
            className="project__link-linear"
        ...
        <ul className="project__list">
          ...
          <li className="project__list-item">
            Browse the art collection: explore different categories, periods and
            styles
          </li>
          <li className="project__list-item">
            Search for specific works: use the search bar to quickly access the
            objects of interest
          </li>
          <li className="project__list-item">
            Browse random exhibits: discover new works of art using the random
            selection feature
          </li>
          <li className="project__list-item">
            Find out detailed information about each work: read descriptions,
            view high-resolution images and study the history of creation
          </li>
          <li className="project__list-item">
            The site provides a user-friendly and intuitive interface for
            exploring the Art Institute of Chicago's rich collection from the
        ...
        <p>
          This site is my graduation project for the{" "}
          <a
          ...
          school. If you want to know more about me or contact me, use the links
          to my CV or github page:
        </p>
